...
#define RNGDNS_PORT		5335
#define RNGDNS_DAPBLOOMSTEP	3				// 3 steps in bloom filter
#define RNGDNS_DAPSHIFTDECAY	8				// Dap time shift 8 = 256 secs (~4min) in decay
#define RNGDNS_DAPTRESHOLD	(4 << RNGDNS_DAPSHIFTDECAY)	// ~4r/s found name, ~1 r/s - clien IP
...
class RngDns {
  public:
     RngDns(const char *bind_ip, uint16_t port_no,
