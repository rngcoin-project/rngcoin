...
space *do not upload these to the rngcoin.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the rngcoin.org server.

```

- Update rngcoin.org version

- Announce the release:

  - rngcoin-dev and rngcoin-dev mailing list

  - blog.rngcoin.org blog post
